...
from ExampleML2.metrics_and_plots import (save_confusion_matrix, save_metrics,
                                          save_predictions)
from ExampleML2.model import evaluate_model, train_model
from ExampleML2.utils_and_constants import load_config, load_data
...
def main(config_file: str, processed_dataset: str):
    ...
    X, y = load_data(processed_dataset, target_column, shuffle, shuffle_random_state)   # noqa

    # Split the dataset
    random_state = config["train_and_evaluate"]["train_test_split"]["random_state"]   # noqa
